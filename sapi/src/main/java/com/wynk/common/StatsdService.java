...
/**
 * Reference :  https://github.com/etsy/statsd/blob/master/examples/StatsdClient.java
 *
 */
public class StatsdService extends TimerTask {

    private static final Logger logger               = LoggerFactory.getLogger(StatsdService.class.getCanonicalName());
    ...
    public StatsdService(String host, int port) throws UnknownHostException, IOException {
        this(InetAddress.getByName(host), port);
    }

    public StatsdService(InetAddress host, int port) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            StatsdService statsdService = new StatsdService("10.0.3.71",8125);
            for (int i = 0; i < 100; i++) {
                statsdService.increment("test1.test");
