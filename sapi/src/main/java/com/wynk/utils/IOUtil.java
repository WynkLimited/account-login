...
//                    logger.warn("IOException while closing buffered reader [{}]", e.toString());
    ...
    public static List<String> readFile(InputStream inputstream, boolean closeStream,boolean skipHeader) throws
            IOException {
...
//                    logger.warn("IOException while closing buffered reader [{}]", e.toString());
    ...
    public static void writeToFile(String fileName, Collection<? extends Object> objList,boolean gzip) {
        ...
        try {
            ...
            for (java.util.Iterator iterator = objList.iterator(); iterator.hasNext(); ) {
